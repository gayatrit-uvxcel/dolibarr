...
abstract class CommonDocGenerator
{
	 ...
	 */
	public function printStdColumnContent($pdf, &$curY, $colKey, $columnText = '', $isCategory = '')
	{
		global $hookmanager;
		...
		if (!$reshook) {
			...
			if ($isCategory) {
				...
				$pdf->writeHTMLCell($colDef['width'], 2, isset($colDef['xStartPos']) ? $colDef['xStartPos'] : 0, $curY, $columnText, 0, 1, true, true, $colDef['content']['align']);
			}
