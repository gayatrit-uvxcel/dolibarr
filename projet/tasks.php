...
if ($action == 'create' && $user->rights->projet->creer && (empty($object->thirdparty->id) || $userWrite > 0)) {
	...
	// 	print $defaultref;
	// }
	print '<input type="text" name="taskref" value="FVAT-' . GETPOST("ref", 'alpha') . '">';
	// print '<input type="text" name="taskref" value="'.(GETPOSTISSET("ref") ? GETPOST("ref", 'alpha') : $defaultref).'">';
	print '</td></tr>';
