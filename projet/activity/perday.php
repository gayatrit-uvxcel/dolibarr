...
if ($action == 'addtime' && $user->rights->projet->lire && GETPOST('formfilteraction') != 'listafterchangingselectedfields') {
	...
	if (count($timespent_duration) > 0) {
		...
		foreach ($timespent_duration as $key => $val) {
			...
			$object->timespent_projectId = GETPOST($key . 'projectId');
			...
			// Validation for required feild by gt
			if (empty($object->timespent_leave_information)) {
				setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("Leave Information")), null, 'errors');
				$error++;
				continue;
			} else if ($object->timespent_leave_information === "FVA-WORKING") {
				if ($object->timespent_duration === '') {
					setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("Timespent Duration")), null, 'errors');
					$error++;
					continue;
				} else if ($object->timespent_main_activity === '') {
					setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("Main activity")), null, 'errors');
					$error++;
					continue;
				} else if ($object->timespent_note === '') {
					setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("Note")), null, 'errors');
					$error++;
					continue;
				} else if ($object->timespent_over_time === '') {
					setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("Over Time")), null, 'errors');
					$error++;
					continue;
				} else if ($object->timespent_night_out === '') {
					setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("Night Out")), null, 'errors');
					$error++;
					continue;
				} else if ($object->timespent_travel_km === '') {
					setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("Travel KM")), null, 'errors');
					$error++;
					continue;
				} else if ($object->timespent_comments === '') {
					setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("Activity Comments")), null, 'errors');
					$error++;
					continue;
				} else if ($object->timespent_ot_pay === '') {
					setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("OT Pay")), null, 'errors');
					$error++;
					continue;
				} else if ($object->timespent_km_pay === '') {
					setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("KM Pay")), null, 'errors');
					$error++;
					continue;
				} else if ($object->timespent_overhead_work === '') {
					setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("Overhead Work")), null, 'errors');
					$error++;
					continue;
				} else if ($object->timespent_accommodation === '') {
					setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("Accommodation")), null, 'errors');
					$error++;
					continue;
				} else if ($object->timespent_local_night_out === '') {
					setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("Local Night Out")), null, 'errors');
					$error++;
					continue;
				} else if ($object->timespent_nital_night_out === '') {
					setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("Intal Night Out")), null, 'errors');
					$error++;
					continue;
				} else if ($object->timespent_nital_night_out === '') {
					setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("Intal Night Out")), null, 'errors');
					$error++;
					continue;
				} else if ($object->timespent_night_out_allowance === '') {
					setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("Night Out Allowance")), null, 'errors');
					$error++;
					continue;
				} else if ($object->timespent_other === '') {
					setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("Other Expense")), null, 'errors');
					$error++;
					continue;
				} else if ($object->timespent_other_comments === '') {
					setEventMessages($langs->trans("ErrorFieldRequired", $langs->transnoentities("Other Expense Comments")), null, 'errors');
					$error++;
					continue;
				}
			}
...
print '<th class="center"><span style="color: red;font-size: 1.5em;"> * </span>' . $langs->trans("Leave Information") . '</th>';
print '<th class="center' . ($cssonholiday ? ' ' . $cssonholiday : '') . ($cssweekend ? ' ' . $cssweekend : '') . '"><span style="color: red;font-size: 1.5em;"> * </span>' . $langs->trans("Duration") . '</th>';
print '<th class="center"><span style="color: red;font-size: 1.5em;"> * </span>' . $langs->trans("Main Activity") . '</th>';
print '<th class="center"><span style="color: red;font-size: 1.5em;"> * </span>' . $langs->trans("Note") . '</th>';
print '<th class="center"><span style="color: red;font-size: 1.5em;"> * </span>' . $langs->trans("OT") . '</th>';
print '<th class="center"><span style="color: red;font-size: 1.5em;"> * </span>' . $langs->trans("Night Out") . '</th>';
print '<th class="center"><span style="color: red;font-size: 1.5em;"> * </span>' . $langs->trans("Travel KM") . '</th>';
print '<th class="center"><span style="color: red;font-size: 1.5em;"> * </span>' . $langs->trans("Activity Comments") . '</th>';
print '<th class="center"><span style="color: red;font-size: 1.5em;"> * </span>' . $langs->trans("OT Pay") . '</th>';
print '<th class="center"><span style="color: red;font-size: 1.5em;"> * </span>' . $langs->trans("KM Pay") . '</th>';
print '<th class="center"><span style="color: red;font-size: 1.5em;"> * </span>' . $langs->trans("Overhead Work") . '</th>';
print '<th class="center"><span style="color: red;font-size: 1.5em;"> * </span>' . $langs->trans("Accommodation") . '</th>';
print '<th class="center"><span style="color: red;font-size: 1.5em;"> * </span>' . $langs->trans("Local Night Out") . '</th>';
print '<th class="center"><span style="color: red;font-size: 1.5em;"> * </span>' . $langs->trans("Intl Night Out") . '</th>';
print '<th class="center"><span style="color: red;font-size: 1.5em;"> * </span>' . $langs->trans("Night Out Allowance") . '</th>';
print '<th class="center"><span style="color: red;font-size: 1.5em;"> * </span>' . $langs->trans("Other Expense") . '</th>';
print '<th class="center"><span style="color: red;font-size: 1.5em;"> * </span>' . $langs->trans("Other Expense Comments") . '</th>';
...
if (count($tasksarray) > 0) {
	...
	if ($conf->use_javascript_ajax) {
		print '<tr class="liste_total">';
		print '<td class="liste_total" colspan="20">';
		print $langs->trans("Total");
		print '</td>';
		if (!empty($arrayfields['timeconsumed']['checked'])) {
			print '<td class="liste_total"></td>';
