...
if ($action == 'create' && $user->rights->projet->creer) {
	...
	// $suggestedref = (GETPOST("ref") ? GETPOST("ref") : $defaultref);
	print '<tr><td class="titlefieldcreate"><span class="fieldrequired">Project Number</span></td><td class>
	<input class="maxwidth150onsmartphone" type="text" name="ref" value="FVAQ-' . htmlspecialchars(GETPOST("ref")) . '">';
	// if ($suggestedref) {
	// 	print ' ' . $form->textwithpicto('', $langs->trans("YouCanCompleteRef", $suggestedref));
	// }
	print '</td></tr>';
