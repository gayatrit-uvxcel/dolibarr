...
class User extends CommonObject
{
	...
	public function create($user, $notrigger = 0)
	{
		...
		// echo "Image",$this->db->escape($this->photo);
		// Clean parameters
		...
		$sql = "INSERT INTO ".$this->db->prefix()."user (datec, login, ldap_sid, entity,photo)";
		// $sql .= " VALUES('".$this->db->idate($this->datec)."', '".$this->db->escape($this->login)."', '".$this->db->escape($this->ldap_sid)."', ".((int) $this->entity).")";.
		$sql .= " VALUES('".$this->db->idate($this->datec)."', '".$this->db->escape($this->login)."', '".$this->db->escape($this->ldap_sid)."', ".((int) $this->entity).", ".($this->photo ? "'".$this->db->escape($this->photo)."'" : "null").")";
		$result = $this->db->query($sql);
